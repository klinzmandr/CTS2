...
if ($action == 'view') {
  ...
  $file = file($fname);
  echo '<div class="container"><a class="btn btn-warning" href="rptmaillogviewer.php">CONTINUE</a><br>';
  foreach ($file as $l) {
    echo $l . '<br>';
    }
  echo '</div>
...
<h3>Mail Log Viewer
&nbsp;&nbsp;<a class="btn btn-primary" href="javascript:self.close();">CLOSE</a>  <a class="btn btn-warning" href="rptmaillogviewer.php">REFRESH</a><br>
</h3>
